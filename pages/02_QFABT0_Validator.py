...
This internal toolkit helps network engineers quickly process and analyse validation reports 
from the LV Portal and Slack reporting systems.
</p>
...
with col1:
    st.markdown("""
    <div class="card">
        <h3>🖥️ Compute Link Validator</h3>
...
with col3:
    st.markdown("""
    <div class="card">
        <h3>📊 Slack Report Highlighter</h3>
